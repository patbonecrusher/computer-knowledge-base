...
Functors are the base of other functional concepts, such as [functor-applicative-monad in pictures](functor-applicative-monad%20in%20pictures.md) like the `Maybe`, `IO`, or `Either` monad and such as [applicative](applicative.md).
