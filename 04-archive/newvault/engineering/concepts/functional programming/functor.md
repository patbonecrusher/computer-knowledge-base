...
Functors are the base of other functional concepts, such as [functor-applicative-monad in pictures](04-archive/newvault/engineering/concepts/functional%20programming/functor-applicative-monad%20in%20pictures.md) like the `Maybe`, `IO`, or `Either` monad and such as [applicative](04-archive/newvault/engineering/concepts/functional%20programming/applicative.md).
