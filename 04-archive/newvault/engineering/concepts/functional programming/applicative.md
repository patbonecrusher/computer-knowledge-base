...
Applicative is a sub-type of [functor](04-archive/newvault/engineering/concepts/functional%20programming/functor.md) with additional available functions: `pure` and `ap`.
