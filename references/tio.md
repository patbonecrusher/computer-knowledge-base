...
title: "GitHub - tio/tio: A serial device I/O tool"
description: "A serial device I/O tool. Contribute to tio/tio development by creating an account on GitHub."
host: github.com
favicon: https://github.githubassets.com/favicons/favicon.svg
image: https://opengraph.githubassets.com/d5f5abeab0a9ed9ad81a40dbe1eb591219fc1be730ac61529fa7f25892145917/tio/tio
```


```
tio --timestamp --timestamp-format iso8601 /dev/...
```
