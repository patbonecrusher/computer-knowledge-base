...
![[_attachments/Pasted image 20250327230517.png]]
...
![[_attachments/Pasted image 20250327230532.png]]
...
![[_attachments/Pasted image 20250327230545.png]]
...
![[_attachments/Pasted image 20250327230618.png]]

A `Functor` is any data type that defines how `fmap` applies to it. Here's how `fmap` works:

![[_attachments/Pasted image 20250327230628.png]]
...
![[_attachments/Pasted image 20250327230638.png]]

So then you're like, alright `fmap`, please apply `(+3)` to a `Nothing`?

![[_attachments/Pasted image 20250327230647.png]]
```
> fmap (+3) Nothing
Nothing
```

![[_attachments/Pasted image 20250327230659.png]]
...
![[_attachments/Pasted image 20250327230711.png]]
...
![[_attachments/Pasted image 20250327230725.png]]
Here's a function applied to another function:

![[_attachments/Pasted image 20250327230738.png]]
...
![[_attachments/Pasted image 20250327230017.png]]

But our functions are wrapped in a context too!

![[_attachments/Pasted image 20250327230027.png]]
...
![[_attachments/Pasted image 20250327230036.png]]
...
![[_attachments/Pasted image 20250327230050.png]]
...
![[_attachments/Pasted image 20250327225249.png]]

Applicatives apply a wrapped function to a wrapped value:
![[_attachments/Pasted image 20250327225308.png]]
...
![[_attachments/Pasted image 20250327225331.png]]
...
![[_attachments/Pasted image 20250327225352.png]]

What if we feed it a wrapped value?

![[_attachments/Pasted image 20250327225410.png]]

We need to use `>>=` to shove our wrapped value into the function. Here's a photo of `>>=`:

![[_attachments/Pasted image 20250327225421.png]]
...
![[_attachments/Pasted image 20250327225437.png]]
...
![[_attachments/Pasted image 20250327225450.png]]

And if you pass in a `Nothing` it's even simpler:

![[_attachments/Pasted image 20250327225510.png]]
...
![[_attachments/Pasted image 20250327225520.png]]

![[_attachments/Pasted image 20250327225530.png]]
...
![[_attachments/Pasted image 20250327225543.png]]

Specifically three functions. `getLine` takes no arguments and gets user input:

![[_attachments/Pasted image 20250327225554.png]]
...
![[_attachments/Pasted image 20250327225604.png]]
...
![[_attachments/Pasted image 20250327225616.png]]
...
![[_attachments/Pasted image 20250327225627.png]]
...
![[_attachments/Pasted image 20250327225118.png]]
